...
def elenca_files_e_estensioni(cartella):
    ...
    for nome_file in os.listdir(cartella):
        ...
        if os.path.isfile(percorso_completo):
            ...
            lista_files_estensioni.append((nome_file, estensione))

    return lista_files_estensioni

def elenca():
# Sostituisci 'percorso_alla_tua_cartella' con il percorso effettivo della cartella che vuoi analizzare
    percorso_cartella = seleziona() #'percorso_alla_tua_cartella'
